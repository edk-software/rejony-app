...
class ProjectAreaRequestRepository
{
    ...
    public function prolongationArea($areaId, $projectId)
    {
        $item = Area::prolongationArea($this->conn, $this->resolver, $projectId, $areaId, $this->tokenStorage->getToken()->getUser()->getId);
        return $item;
    }
